...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { Direccion: @empleado.Direccion, Nombre: @empleado.Nombre, Puesto: @empleado.Puesto, Telefono: @empleado.Telefono, id_empleado: @empleado.id_empleado }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { Direccion: @empleado.Direccion, Nombre: @empleado.Nombre, Puesto: @empleado.Puesto, Telefono: @empleado.Telefono, id_empleado: @empleado.id_empleado }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
