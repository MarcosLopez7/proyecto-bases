...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { Direccion: @proveedor.Direccion, Nombre: @proveedor.Nombre, Producto: @proveedor.Producto, Telefono: @proveedor.Telefono, id_empleado: @proveedor.id_empleado, id_provedor: @proveedor.id_provedor }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { Direccion: @proveedor.Direccion, Nombre: @proveedor.Nombre, Producto: @proveedor.Producto, Telefono: @proveedor.Telefono, id_empleado: @proveedor.id_empleado, id_provedor: @proveedor.id_provedor }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
